                ...
                @endif
                    <form class="form-horizontal p-t-20" method="POST" action="{{route('brand.update',['id'=>$brand->id])}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="name" id="exampleInputuname3" value="{{$brand->name}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="exampleInputEmail3" class="col-sm-3 control-label">Brand Description<span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <textarea type="email" class="form-control" name="description" id="exampleInputEmail3" placeholder="Brand Description">{{$brand->description}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img src="{{asset($brand->image)}}" alt="" height="60px" width="100px">
                            </div>
                        </div>
                        <div class="form-group row">
