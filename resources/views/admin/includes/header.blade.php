        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="{{route('dashboard')}}">
                <!-- Logo icon --><b>
                    ...
                    <!-- Dark Logo icon -->
                    <img  src="{{asset('/')}}website/assets/images/logo/k.png" alt="homepage" class="dark-logo" />
                    <!-- Light Logo icon -->
                </b>
                <!--End Logo icon -->
                <!-- Logo text --><span>
                 ...
                 <img  src="{{asset('/')}}website/assets/images/logo/k.png" alt="homepage" class="dark-logo" />
                 <!-- Light Logo text -->    
                 <img  src="{{asset('/')}}website/assets/images/logo/k.png" class="light-logo" alt="homepage" height="60px" width="200px"/></span> </a>
        </div>
        <!-- ============================================================== -->
        <!-- End Logo -->
        <!-- ============================================================== -->
