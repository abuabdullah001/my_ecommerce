...
@section('title', 'Shop singale page')
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        ...
                        <div class="product-info">
                            ...
                            <p class="category">
                                ...
                                <a href="javascript:void(0)">{{$products->category->name}}</a>
                            </p>
                            <p class="category">
                                <i class="lni lni-tag"></i>Product Sub Category:
                                <a href="javascript:void(0)">{{$products->subCategory->name}}</a>
                            </p>
                            <p class="category">
                                <i class="lni lni-tag"></i>Product Brand:
                                <a href="javascript:void(0)">{{$products->brand->name}}</a>
                            </p>
                            <h3 class="price">৳{{$products->selling_price}}<span>৳{{$products->regular_price}}</span></h3>
                            <p class="info-text">{{$products->short_description}}</p>
                            <form action="{{route('add-to-cart',['id'=>$products->id])}}" method="POST" >
                                @csrf
                                <div class="row">
                                    <div class="col-12">
