...
<head>
    ...
    <title>AM Dairy Farm - @yield('title')</title>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-3 col-7">
                        ...
                        <a class="navbar-brand" href="{{ route('home.page') }}">
                            <img src="{{ asset('/') }}website/assets/images/logo/k.png" alt="Logo">
                        </a>
                                ...
                                <div class="cart-items">
                                    ...
                                    <div class="shopping-item">
                                        ...
                                        <ul class="shopping-list">
                                            ...
                                            <li>
                                                <a  class="remove" title="Remove this item" onclick="return confirm('Are you sure?')" href="{{route('remove-cart-product',['id'=>$item->__raw_id])}}">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <p class="quantity">{{$item->qty}}x - <span class="amount">{{$item->price}}=৳{{$item->price*$item->qty}}</span></p>
                                                </div>
                                            </li>
                                        ...
                                        <div class="bottom">
                                            ...
                                            <div class="button">
                                                <a href="{{route('checkout.page')}}" class="btn animate">Checkout</a>
                                            </div>
                                            <span class="bg-success" id="notification" style="display:none;"></span>
                                        </div>
                                    </div>
                            ...
                            <ul class="sub-category">
                                ...
                                <li>
                                    <a href="{{route('product-category', ['id'=>$category->id])}}">{{$category->name}}
                                        @if (count($category->subCategorise)>0)
                                        <i class="lni lni-chevron-right"></i> 
                                    </a>
                                        <ul class="inner-sub-category">
                                            @foreach ($category->subCategorise as $subCategory)
